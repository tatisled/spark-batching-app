...
//     StructType(StructField(Address,StringType,true), StructField(City,StringType,true), StructField(Country,StringType,true), StructField(Geohash,StringType,true), StructField(Id,StringType,true), StructField(Latitude,StringType,true), StructField(Longitude,StringType,true), StructField(Name,StringType,true))
